...
export class InvestmentController {
  ...
  getById = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    const { id } = req.params;
    const investment = await this.investmentService.getInvestmentById(id, req.user);
  ...
  create = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const investment = await this.investmentService.createInvestment(req.body, req.user);
  ...
  update = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const { id } = req.params;
    const investment = await this.investmentService.updateInvestment(id, req.body);
    const investmentObj = investment.toObject();
