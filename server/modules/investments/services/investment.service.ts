...
export class InvestmentService {
  ...
  private calculateCurrentValue(
    ...
    const performanceChange = currentAssetPerformance - assetPerformanceAtInvestment;
  ...
  private enrichInvestmentsWithCurrentValue(
    ...
    return investments.map((inv) => {
      ...
      return {
        ...
        assetId: typeof inv.assetId === 'string' ? inv.assetId : inv.assetId._id.toString(),
  ...
  async getAllInvestmentsPaginated(
    ...
    const enrichedInvestments = this.enrichInvestmentsWithCurrentValue(result.investments);
  ...
  async getAllInvestments(user: User): Promise<InvestmentWithCalculatedValue[]> {
    // Admins can see all investments, regular users see only their own
    const investments =
      user.role === 'admin'
  ...
  async getInvestmentById(id: string, user: User): Promise<InvestmentWithCalculatedValue> {
  ...
  async updateInvestment(id: string, data: UpdateInvestmentData): Promise<IInvestment> {
